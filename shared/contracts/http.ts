...
export type ProofVerifyRequest = { proof_id: string; requirements: Record<string, unknown> };
export type ProofVerifyResponse = { verified: boolean; details: Record<string, unknown> };
